...
/* tagging */
static const char *tags[] = { "1", "Chrom", "FF", "NB", "5", "6", "7", "8", "9" };
...
//static const char *primmoncmd[]  = { "source /home/frost/bin/primonitor.sh", NULL };
//static const char *secmoncmd[]  = { "source /home/frost/bin/secmonitor.sh", NULL };
...
static Key keys[] = {
	...
	/* Start Flextile hacks */
	{ MODKEY|ControlMask,           XK_t,      rotatelayoutaxis,  {.i = 0} },
	{ MODKEY|ControlMask|ShiftMask,	XK_Tab,	   rotatelayoutaxis,  {.i = 1} },
	...
	{ MODKEY,			XK_z,	   spawn,	   {.v = volup } },
	{ MODKEY,			XK_x,	   spawn,	   {.v = voldown } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
